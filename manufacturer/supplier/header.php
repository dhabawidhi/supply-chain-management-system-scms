...
<header id="header">
				<div class="inner">
					...
					<!-- Logo -->
				<h1><a href="../index.php" id="logo">Manufacturer - SCMS RMO</a></h1>

			<!-- Nav -->
				<nav id="nav">					
					<ul>
						<li><a href="../index.php">Isi Gudang</a></li>
						<li class="current_page_item"><a href="../supplier/index.php">Supplier</a></li>
						<li>
